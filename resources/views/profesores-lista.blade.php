                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <a href="{{ route('profesores.show', $profesor->id_profesor) }}" class="btn btn-info btn-sm">Ver</a>
                                    <a href="{{ route('profesores.edit', $profesor->id_profesor) }}" class="btn btn-warning btn-sm">Editar</a>
                                    <form action="{{ route('profesores.destroy', $profesor->id_profesor) }}" method="POST" style="display:inline-block">
                                        @csrf
                                        @method('DELETE')
