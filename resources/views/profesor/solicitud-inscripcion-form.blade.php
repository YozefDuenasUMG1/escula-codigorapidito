<div class="card shadow-lg border-0 mx-auto" style="max-width: 500px; margin-top: 30px;">
    <div class="card-body">
        <h4 class="mb-4 text-center text-primary">Solicitud de Inscripción como Profesor</h4>
        @if(session('success'))
        ...
        @endif
        <form action="{{ route('solicitud-inscripcion-profesor.store') }}" method="POST">
            @csrf
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <input type="text" name="especialidad" class="form-control rounded-pill" required>
            </div>
            <div class="d-grid gap-2 d-md-flex justify-content-md-between mt-3">
                ...
                <a href="{{ route('dashboard.profesor') }}" class="btn btn-secondary rounded-pill">Cancelar</a>
            </div>
        </form>
    </div>
</div> 