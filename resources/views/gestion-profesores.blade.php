                ...
                <div class="card-body">
                    <form class="row g-3 mb-4">
                        ...
                        <div class="col-md-4 d-flex align-items-end">
                            <button type="button" class="btn btn-primary w-100" onclick="filtrarTablaProfesores()">Filtrar</button>
                        </div>
                    </form>
                    <table class="table table-striped" id="tablaProfesores">
                        <thead>
                            <tr>
                                <th onclick="ordenarTablaProfesores(0)">#</th>
                                <th onclick="ordenarTablaProfesores(1)">Nombre</th>
                                <th onclick="ordenarTablaProfesores(2)">Email</th>
                                <th onclick="ordenarTablaProfesores(3)">Teléfono</th>
                                <th onclick="ordenarTablaProfesores(4)">Especialidad</th>
                                <th onclick="ordenarTablaProfesores(5)">Sucursal</th>
                                <th onclick="ordenarTablaProfesores(6)">Nivel</th>
                            </tr>
                        </thead>
                        <tbody>
...
function ordenarTablaProfesores(n) {
    var tabla = document.getElementById('tablaProfesores');
