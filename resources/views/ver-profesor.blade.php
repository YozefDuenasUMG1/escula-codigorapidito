...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Detalles del Profesor</h1>
    <div class="bg-white shadow rounded p-6">
        ...
        <a href="{{ route('profesores.lista') }}" class="mt-4 ml-2 inline-block bg-gray-300 text-gray-800 px-4 py-2 rounded hover:bg-gray-400">Volver</a>
    </div>
</div>
@endsection 