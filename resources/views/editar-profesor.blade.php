...
<div class="container mx-auto p-4">
    <h1 class="text-2xl font-bold mb-4">Editar Profesor</h1>
    <form action="{{ route('profesores.update', $docente->id_profesor) }}" method="POST" class="bg-white shadow rounded p-6">
        ...
        <a href="{{ route('profesores.lista') }}" class="ml-2 bg-gray-500 text-white px-4 py-2 rounded hover:bg-gray-600 mt-4">Cancelar</a>
    </form>
</div>
@endsection 